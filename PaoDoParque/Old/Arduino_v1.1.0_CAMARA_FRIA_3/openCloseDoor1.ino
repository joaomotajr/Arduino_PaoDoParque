...
void sendOpenClose1(String value) {
    ...
    if(!(STATIC1 == value)) {
        ...
        if(value == CLOSE1) {                          
            ...
            Serial.println("Send ID 109 PORTA 1 FECHADA NO E-GAS");      
            ...
            Serial.println("Send ID 109 PORTA 1 ABERTA NO E-GAS");
        }    
        COUNT_TIMER1 = millis();           
    }
    else {
        ...
        if((millis() - COUNT_TIMER1) > INTERVAL_SEND_TIME1) {
            ...
            if(STATIC1 == OPEN1) {
                ...
                Serial.println("Send ID 109 PORTA 1 ABERTA  POR " + timeOpenedLog  + " segundos no E-Gas");
