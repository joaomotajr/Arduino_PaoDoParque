...
void sendOpenClose2(String value) {
    ...
    if(!(STATIC2 == value)) {
        ...
        if(value == CLOSE2) {                          
            ...
            Serial.println("Send ID 110 PORTA 2 FECHADA NO E-GAS");      
            ...
            Serial.println("Send ID 110 PORTA 2 ABERTA NO E-GAS");
        }    
        COUNT_TIMER2 = millis();           
    }
    else {
        ...
        if((millis() - COUNT_TIMER2) > INTERVAL_SEND_TIME2) {
            ...
            if(STATIC2 == OPEN2) {
                ...
                Serial.println("Send ID 110 PORTA 2 ABERTA  POR " + timeOpenedLog  + " segundos no E-Gas");
