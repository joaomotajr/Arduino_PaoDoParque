...
void sendOpenClose1(String value) {
    ...
    if(!(STATIC1 == value)) {      
        if(value == CLOSE) {
            ...
            Serial.println(String(millis()) + " ID [" + String(idTimer1) + "] Send PORTA 1 FECHADA NO E-GAS");     
            ...
            Serial.println(String(millis()) + " ID [" + String(idTimer1) + "] Send PORTA 1 ABERTA NO E-GAS");
        }    
        COUNT_TIMER1 = millis();           
    } else {
        if((millis() - COUNT_TIMER1) > INTERVAL_SEND_TIME) {      
            if(STATIC1 == OPEN) {
                ...
                Serial.println(String(millis()) + " ID [" + String(idTimer1) + "] Send PORTA 1 ABERTA  POR " + timeOpenedLog  + " segundos no E-Gas");
